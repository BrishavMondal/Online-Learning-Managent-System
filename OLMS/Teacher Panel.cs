    ...
    public partial class Teacher_Portal : Form
    {
        ...
        private void bt_search_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                tuser.Text = stu.User_Id.ToString();
        ...
        {
            int updated_studentid = int.Parse(tb_uname.Text);
            string updated_contact = Contact_textbox.Text;
            string updated_course = C_textbox.Text;
            string updated_department = D_textbox.Text;
            int updated_userid = int.Parse(tuser.Text);


            Student stu = new Student();
            stu.Student_Id = int.Parse(tb_uname.Text);
            stu.User_Id = int.Parse(tuser.Text);
            ...
            if (rs == true)
            {
                dgv2.DataSource = db.Student.Get_All_Students();
